...
export default function Sidenav() {
  const [submenuItemsState, setSubmenuItemsState] = useState<any>({});

  const toggleSubmenuItem = (e: any, key: string) => {
    e.stopPropagation();
    e.preventDefault();
    const newState = submenuItemsState;
    newState[key] = !newState[key];
    setSubmenuItemsState(newState);
  };
